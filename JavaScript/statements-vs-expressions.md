...
It is a full command: declare a variable `s` and initialize it with `"Pixel To Code"`. JavaScript doesn't need any other information to know what we want. The statement is terminated with a semicolon.
...
<a href="https://www.youtube.com/watch?v=WVyCrI1cHi8">
